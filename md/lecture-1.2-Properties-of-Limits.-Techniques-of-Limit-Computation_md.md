...
● [12:20](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=740). 🧩 Evaluation of limₓ→₂  𝒙³ - 2𝒙 + 7: [📷image](../img/Calculus 1 Lecture 1.2/[12-20]-01.png) 
...
● [20:16](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=1216). 🧩 Evaluation of limₓ→₂  (𝒙⁵ - 3𝒙 + 4)³: [📷image](../img/Calculus 1 Lecture 1.2/[20-16]-01.png) 
...
● [23:05](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=1385). 🧩  Evaluation of limₓ→₂  (4𝒙² + 1) / (𝒙 + 3): [📷image](../img/Calculus 1 Lecture 1.2/[23-05]-01.png) 
...
● [26:20](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=1580). 🧩 Evaluation of  limₓ→₁   ∛((5𝒙 + 7) / (𝒙² + 1)) [📷image](../img/Calculus 1 Lecture 1.2/[26-20]-01.png) 
...
● [28:50](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=1730). 🧩 Evaluation of  limₓ→₂  (𝒙² - 4) / (𝒙-2) [📷image](../img/Calculus 1 Lecture 1.2/[28-50]-01.png) 
     ◉ limₓ→₂  (𝒙² − 4) / (𝒙 − 2)  
         limₓ→₂ [ ((𝒙 + 2)(𝒙 − 2)) / (𝒙 − 2)
         limₓ→₂  [ (𝒙 + 2)  ] 
...
● [33:45](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=2025). Factorization and Simplification to Evaluate Limits: 
     ◉ 🧩 Evaluation of limₓ→₋₄  (2𝒙 + 8) / (𝒙² + 𝒙 - 12) [📷image](../img/Calculus 1 Lecture 1.2/[33-45]-01.png) 
              limₓ→₋₄ (2𝒙 + 8) / (𝒙² + 𝒙 − 12) 
               limₓ→₋₄  2(𝒙 + 4) / ((𝒙 + 4)(𝒙 − 3)) 
...
● [38:23](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=2303). 🧩 Evaluation of limₓ→₅  (𝒙² - 3𝒙 - 10) / (𝒙² - 10𝒙 + 25) [📷image](../img/Calculus 1 Lecture 1.2/[38-23]-01.png) 
...
● [47:35](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=2855). Summary of Techniques for Evaluating Limits [📷image](../img/Calculus 1 Lecture 1.2/[47-35]-01.png) 
     ◉ 📝N͟O͟T͟E͟::
...
● [50:50](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=3050). 🧩 Evaluation of limₓ→₁ (𝒙 -1 ) /  (√(𝒙) - 1) [📷image](../img/Calculus 1 Lecture 1.2/[50-50]-01.png) 
     ◉ limₓ→₁ (𝒙−1) / (√(𝒙)−1) 
         limₓ→₁ (𝒙−1)∙(√(𝒙)+1)  /  (𝒙−1)       Multiply by the conjugate: (√𝒙+1) / (√𝒙+1)
         limₓ→₁ √(𝒙) + 1                               Simplify cancelling (𝒙−1)
         √1 + 1 = 2                                       Substitute directly
        
● [55:25](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=3325). 🧩 Evaluation of limₓ→₀  (√(1+𝒙) - 1) / 𝒙  [📷image](../img/Calculus 1 Lecture 1.2/[55-25]-01.png) 
     ◉ limₓ→₀  (√(1+𝒙) − 1) / 𝒙 
...
● [1:19:43](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=4783). 𝙨𝒊𝙣(𝒙) 𝒂𝙣𝒅 𝒄𝙤𝒔(𝒙) 𝙖𝒓𝙚 𝙘𝒐𝙣𝒕𝙞𝒏𝙪𝒐𝙪𝒔 𝒆𝙫𝒆𝙧𝒚𝙬𝒉𝙚𝒓𝙚. [📷image](../img/Calculus 1 Lecture 1.2/[1-19-43]-01.png) 
     ◉ limₓ→ₐ 𝐬𝐢𝐧(𝒙) = 𝐬𝐢𝐧(𝒂)
     ◉ limₓ→ₐ 𝐜𝐨𝐬(𝒙) = 𝐜𝐨𝐬(𝒂)

● [1:22:32](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=4952).  𝑻𝒉𝒆 𝒇𝒖𝒏𝒄𝒕𝒊𝒐𝒏 𝒕𝒂𝒏(𝒙) 𝒆𝒙𝒊𝒔𝒕𝒔 𝒆𝒙𝒄𝒆𝒑𝒕 𝒂𝒕 𝒕𝒉𝒆 𝒑𝒐𝒊𝒏𝒕𝒔 𝒘𝒉𝒆𝒓𝒆 𝒄𝒐𝒔(𝒙) = 0. 𝑻𝒉𝒆𝒔𝒆 𝒑𝒐𝒊𝒏𝒕𝒔 𝒂𝒓𝒆 𝒙 = ±π/2 + 𝒏π, 𝒏 ∈ 𝒁. [📷image](../img/Calculus 1 Lecture 1.2/[1-22-32]-01.png) 
     ◉ limₓ→ₐ tan(𝒙) = tan(a) ; 𝒙 ≠ ±π/2 + 𝒏π, 𝒏 ∈ 𝒁.  

● [1:28:15](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=5295). 🧩 Evaluation of limₓ→₁  𝐜𝐨𝐬((𝒙²−1) / (𝒙−1)) [📷image](../img/Calculus 1 Lecture 1.2/[1-28-15]-01.png) 
     ◉ cos(𝒙) is 𝒄𝒐𝒏𝒕𝒊𝒏𝒖𝒐𝒖𝒔 𝒔𝒐 𝒃𝒚 𝒄𝒐𝒎𝒑𝒐𝒔𝒊𝒕𝒊𝒐𝒏 ...
         ...
         𝐜𝐨𝐬(1+1)
         𝐜𝐨𝐬(2)
     ◉ 📝 N͟O͟T͟E͟:: Since 𝐜𝐨𝐬(𝒙) is continuous, we can move the limit inside by the composition rule:
...
● [1:33:00](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=5580). 🧩 Evaluation of limₓ→π∕₂  3𝒙² + cos(𝒙) [📷image](../img/Calculus 1 Lecture 1.2/[1-33-00]-01.png) 
...
● [1:37:15](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=5835). ∴ 𝑫𝒆𝒎𝒐𝒏𝒔𝒕𝒓𝒂𝒕𝒊𝒐𝒏 𝒐𝒇 limₓ→₀ 𝒔𝒊𝒏 (𝒙) / 𝒙 = 1 [📷image-1](../img/Calculus 1 Lecture 1.2/[1-37-15]-01.png) [📷image-2](../img/Calculus 1 Lecture 1.2/[1-37-15]-02.png) 
     ...
     ◉ 📝 N͟O͟T͟E͟:: In the proof using the Squeeze Theorem for limₓ→₀ (𝒔𝒊𝒏(𝒙)/𝒙) = 1, it is correct to use the symbol "<" instead of "≤". 
                           The reason is:
...
● [1:55:00](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=6900). 🧩 Evaluation of limₓ→₀ (1 - cos 𝒙) / 𝒙 [📷image](../img/Calculus 1 Lecture 1.2/[1-55-00]-01.png) 
...
● [2:02:55](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=7375).  🧩 Evaluation of limₓ→₀ tan 𝒙 / 𝒙 [📷image](../img/Calculus 1 Lecture 1.2/[2-02-55]-01.png) 
...
● [2:08:00](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=7680). 🧩 Evaluation of limₓ→₀  sin (2𝒙) / 𝒙 [📷image](../img/Calculus 1 Lecture 1.2/[2-08-00]-01.png) 
...
● [2:13:40](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=8020). 🧩 Evaluation of limₓ→₀ sin (5𝒙) / 6𝒙 [📷image](../img/Calculus 1 Lecture 1.2/[2-13-40]-01.png) 
...
● [2:20:25](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=8425). 🧩 Evaluation of  limₓ→₀  sin (𝒙²) / 𝒙 [📷image](../img/Calculus 1 Lecture 1.2/[2-20-25]-01.png) 
...
● [2:24:20](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=8660). 🧩 Evaluation of limₓ→₀  sin² (𝒙) / 𝒙  [📷image](../img/Calculus 1 Lecture 1.2/[2-24-20]-01.png) 
...
● [2:25:45](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=8745). 🧩 Evaluation of limₓ→₀ sin (1 / 𝒙) (Graphical approach) [📷image](../img/Calculus 1 Lecture 1.2/[2-25-45]-02.png) 
     ◉ limₓ→₀ sin (1 / 𝒙) = D.N.E
     ◉ Graph behavior:
...
● [2:25:45](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=8745). 🧩 Evaluation of limₓ→₀  𝒙∙sin (1 / 𝒙) [📷image](../img/Calculus 1 Lecture 1.2/[2-25-45]-01.png) 
...
● [2:35:33](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=9333). 🧩 Evaluation of limₓ→₀  (2 - cos(3𝒙) - cos(4𝒙)) / 𝒙 [📷image](../img/Calculus 1 Lecture 1.2/[2-35-33]-01.png) 
...
● [2:40:45](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=9645). 🧩 Evaluation of limₓ→₀  (𝒙²− 3·sin(𝒙)) / 𝒙 [📷image](../img/Calculus 1 Lecture 1.2/[2-40-45]-01.png) 
...
● [2:42:24](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=9744). 🧩 Evaluation of limₜ→₀  t² / (1 - cos²(t)) [📷image](../img/Calculus 1 Lecture 1.2/[2-42-24]-01.png) 
...
● [2:50:00](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=10200). 🧩 Evaluation of limₓ→₀   𝒙 / cos(π/2 - 𝒙) [📷image](../img/Calculus 1 Lecture 1.2/[2-50-00]-01.png) 
     ◉ Use the co-function identity:
               cos(π/2 − 𝒙) = sin(𝒙)
          ○ 📝 N͟O͟T͟E͟:  Two angles are omplementary if they add up to 90°
...
● [2:53:40](https://www.youtube.com/watch?v=VSqOZNULRjQ&t=10420). 🧩 Evaluation of  lim_(θ→0)  θ² / (1 - cos(θ))  [📷image](../img/Calculus 1 Lecture 1.2/[2-53-40]-01.png) 
