...
● Presentation of the 🧩 Example –: 𝒇(𝒙) = (𝒙 + 2)(𝒙 - 1)²  
...
● [6:04](https://www.youtube.com/watch?v=8u6woY05aL&t=364). Step 2: Find asymptotes (only for rational 𝒇(𝒙))
    ...
    ❶ ᴠ̳ᴇ̳ʀ̳ᴛ̳ɪ̳ᴄ̳ᴀ̳ʟ̳ ̳ᴀ̳ꜱ̳ʏ̳ᴍ̳ᴘ̳ᴛ̳ᴏ̳ᴛ̳ᴇ̳ꜱ̳: Arise when the function tends to ±∞ as 𝒙 approaches a specific value.
          ...
          ○ 🗒️ NOTE: The existence of a vertical asymptote **does not require** the two-sided limit to diverge in the same way or to exist at all.
