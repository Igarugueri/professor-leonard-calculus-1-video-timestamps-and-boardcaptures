...
● [10:44](https://www.youtube.com/watch?v=nQ6tOORDQ3I&list=PLF797E961509B4EB5&t=644). 🧩 Example –: Application of the first derivative test to an example 𝒇(𝒙) = 𝒙³ -3𝒙 +1 [📷image](../img/Calculus 1 Lecture 3.3/[10-44]-01.png) 
...
● [17:12](https://www.youtube.com/watch?v=nQ6tOORDQ3I&list=PLF797E961509B4EB5&t=1032). 🧩 Example –: Presentation of a second example to apply the first derivative test 𝒇(𝒙) = 3𝒙⁵ᐟ³ − 15𝒙²ᐟ³ [📷image](../img/Calculus 1 Lecture 3.3/[17-12]-01.png)
     ❶ Find the first derivative:  
