...
● [2:14](https://www.youtube.com/watch?v=aiBD9aI69C8&t=134). ∫ (𝒙² + 1)·2𝒙·𝒅𝒙
...
● [3:20](https://www.youtube.com/watch?v=aiBD9aI69C8&t=200). Substitution is a method to handle complex integrals.  [📷image](../img/Calculus 1 Lecture 4.2/[3-20]-01.png) 
     ...
     ❷ [6:15](https://www.youtube.com/watch?v=aiBD9aI69C8&t=375). Transform: ∫ 𝒙·𝒅𝒙 → ∫ 𝑢·𝒅𝑢
...
● [9:30](https://www.youtube.com/watch?v=aiBD9aI69C8&t=570).  🧩 Example (continuation) –:  ∫ (𝒙² + 1)⁵⁰·2𝒙·𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[9-30]-01.png) 
...
● [17:19](https://www.youtube.com/watch?v=aiBD9aI69C8&t=1039).  ∫ 𝒙² · (𝒙³ - 4)⁵ · 𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[17-19]-01.png) 
     ◉ 𝑢 = 𝒙³ - 4  →  𝒅𝑢 = 3𝒙² 𝒅𝒙  →   𝒅𝒙 =  𝒅𝑢 / 3𝒙²  
     ◉ ∫ 𝒙² · 𝑢⁵ · (𝒅𝑢 / 3𝒙²)  =  1/3) ∫ 𝑢⁵ 𝒅𝑢  =
     ◉ = (1/3) · (𝑢⁶ / 6) + 𝓒  
     ◉ Translate back to "𝒙": ((𝒙³ - 4)⁶) / 18 + 𝓒

● [21:13](https://www.youtube.com/watch?v=aiBD9aI69C8&t=1273).  ∫ 𝒙²·(𝒙³ - 4)⁵·𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[21-13]-01.png) 
     ◉ 𝑢 = 𝒙⁴  →  𝒅𝑢 = 4𝒙³ · 𝒅𝒙  →  𝒅𝒙 = 𝒅𝑢 / 4𝒙³  
     ◉ ∫ 2𝒙³ · sin(u) · (𝒅𝑢 / 4𝒙³)   =  (2 / 4) ∫ sin(u) · 𝒅𝑢  =
     ◉ = (1 / 2) (-cos(u)) + 𝓒  
     ◉ Translate back to "𝒙":  -(1 / 2)·cos(𝒙⁴) + 𝓒

● [27:20](https://www.youtube.com/watch?v=aiBD9aI69C8&t=1640). ∫ [ (1 / 𝒙²) + sec²(π·𝒙) ]· 𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[27-20]-01.png) 
     ◉ ∫ [1/𝒙² · 𝒅𝒙  +  ∫ sec²(π𝒙)· 𝒅𝒙
     ◉  ∫ (1/𝒙²) · 𝒅𝒙 = -1/𝒙 + 𝓒
     ◉ ∫ sec²(π·𝒙) · 𝒅𝒙
...
● [29:00](https://www.youtube.com/watch?v=aiBD9aI69C8&t=1740). ∫ cos(5𝒙)· 𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[29-00]-01.png) 
     ◉  𝑢 = 5𝒙  →  𝒅𝑢 = 5 · 𝒅𝒙  →  𝒅𝒙 = 𝒅𝑢 / 5
     ◉ ∫ cos(5𝒙) · 𝒅𝒙 = ∫ cos(𝑢)·(𝒅𝑢 / 5)
     ◉  (1/5) ∫ cos(𝑢)·𝒅𝑢 = (1/5) sin(𝑢) 
     ◉ Translate back to "𝒙":    (1/5) sin(5𝒙) + 𝓒

● [34:50](https://www.youtube.com/watch?v=aiBD9aI69C8&t=2090).  ∫ (2𝒙 - 3)¹⁵· 𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[36-46]-02.png) 
     ◉ 𝑢 = 2𝒙 - 3  →  𝒅𝑢 = 2·𝒅𝒙  →  𝒅𝒙 = 𝒅𝑢 / 2
     ◉ ∫ (2𝒙 - 3)¹⁵·𝒅𝒙  =  ∫ 𝑢¹⁵·(𝒅𝑢 / 2)
     ◉ (1/2) ∫ 𝑢¹⁵·𝒅𝑢 =   (1/2) (𝑢¹⁶ / 16)  =   𝑢¹⁶ / 32 
     ◉ Translate back to "𝒙":     (2𝒙 - 3)¹⁶ / 32 + 𝓒

● [36:46](https://www.youtube.com/watch?v=aiBD9aI69C8&t=2206). ∫ (1/𝒙²) + sec²(π𝒙) · 𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[36-46]-01.png) 
     ◉ ∫ [1/𝒙² + sec²(π𝒙)] · 𝒅𝒙
     ◉ ∫ (1/𝒙²) 𝒅𝒙 + ∫ sec²(π𝒙) · 𝒅𝒙
...
● [44:33](https://www.youtube.com/watch?v=aiBD9aI69C8&t=2673). ∫ sin²(𝒙)·cos(𝒙)·𝒅𝒙  (𝑢 = cos(𝒙) ) [📷image](../img/Calculus 1 Lecture 4.2/[44-33]-01.png) 
...
● [47:00](https://www.youtube.com/watch?v=aiBD9aI69C8&t=2820). ∫ sin²(𝒙)·cos(𝒙)·𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[47-00]-01.png) 
     ◉ ∫ sin²(𝒙) cos(𝒙) · 𝒅𝒙 
          ○ 𝑢 = sin(𝒙),  𝒅𝑢 = cos(𝒙) · 𝒅𝒙
     ◉ ∫ 𝑢² · cos(𝒙) · (𝒅𝑢 / cos(𝒙))
     ◉ ∫ 𝑢² · 𝒅𝑢  →  (𝑢³ / 3) + 𝓒
...
● [51:25](https://www.youtube.com/watch?v=aiBD9aI69C8&t=3085). ∫ (cos(√𝒙) / √𝒙) · 𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[51-25]-01.png) 
     ◉ 𝑢 = √𝒙 → 𝒅𝑢 = (1/2) · 𝒙⁻¹ᐟ²· 𝒅𝒙
     ◉ 2 · 𝒅𝑢 = 𝒙⁻¹ᐟ² · 𝒅𝒙 → 2 · 𝒅𝑢 = 1/𝑢· 𝒅𝒙 → 𝒅𝒙 = 2𝑢·𝒅𝑢 because 𝑢 = √𝒙
     ◉ ∫ (cos(𝑢) / 𝑢) · 2𝑢 · 𝒅𝑢 → 2·∫ cos(𝑢)· 𝒅𝑢 = 2·sen(𝑢) + 𝓒 
     ◉Translate back to "𝒙": 2·sen(√𝒙) + 𝓒

● [1:00:00](https://www.youtube.com/watch?v=aiBD9aI69C8&t=3600). ∫ 𝒙⁴ (³√(3 - 5𝒙⁵)) · 𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[1-00-00]-01.png) 
...
● [1:08:40](https://www.youtube.com/watch?v=aiBD9aI69C8&t=4120). ∫ 𝒙² √(𝒙 - 1) · 𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[1-08-40]-01.png) 
     ◉ 𝑢 = 𝒙 - 1  →  𝒙 = 𝑢 + 1 → 𝒅𝑢 = 𝒅𝒙
     ◉  ∫ 𝒙² √𝑢 · 𝒅𝑢 
          ○ 𝒙² = (𝑢 + 1)² = 𝑢² + 2𝑢 + 1
          ○ ∫ 𝒙² √𝑢 · 𝒅𝑢  →  ∫ (𝑢² + 2𝑢 + 1) · √𝑢 · 𝒅𝑢
...
● [1:17:40](https://www.youtube.com/watch?v=aiBD9aI69C8&t=4660). ∫ (2 - 𝒙) / √(2𝒙² - 8𝒙 + 1) · 𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[1-17-40]-01.png) 
...
● [1:25:07](https://www.youtube.com/watch?v=aiBD9aI69C8&t=5107).  ∫ cos³(𝒙) · 𝒅𝒙 [📷image](../img/Calculus 1 Lecture 4.2/[1-25-07]-01.png) 
