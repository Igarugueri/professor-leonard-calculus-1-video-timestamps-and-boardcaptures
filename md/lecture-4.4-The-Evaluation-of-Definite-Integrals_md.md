...
● [7:00](https://www.youtube.com/watch?v=K0ORDCt5Ig0&t=420). 🧩 Example – 1: ∫[1,4] 2·𝒅𝑥 [📷image](../img/Calculus 1 Lecture 4.4/[7-00]-01.png)
...
● [9:00](https://www.youtube.com/watch?v=K0ORDCt5Ig0&t=540). 🧩 Example – 2: ∫[-1,2] (𝒙 + 2)·𝒅𝑥 [📷image](../img/Calculus 1 Lecture 4.4/[9-00]-01.png)
     ◉𝒇(𝒙) = 𝒙 + 2.
     ◉ Graph of 𝒇(𝒙) = 𝒙 + 2.
...
● [12:15](https://www.youtube.com/watch?v=K0ORDCt5Ig0&t=735). 🧩 Example – 3: ∫[0,1] √(1 - 𝒙²)·𝒅𝑥 [📷image](../img/Calculus 1 Lecture 4.4/[12-15]-01.png)
     ...
     ◉ Definite integrals can sometimes be solved using geometric methods.
          ...
          ○ [15:24](https://www.youtube.com/watch?v=K0ORDCt5Ig0&t=924). We require more advanced methods for functions like 𝒙³ or 𝒙².
...
● [28:20](https://www.youtube.com/watch?v=K0ORDCt5Ig0&t=1700). 🧩 Example – Evaluate geometrically: ∫[0,1] (4 − 2√(1 − 𝒙²)) · 𝒅𝒙  [📷image](../img/Calculus 1 Lecture 4.4/[28-20]-01.png)
