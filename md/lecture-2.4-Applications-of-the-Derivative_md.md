...
● [00:01](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=1). Introduction to Applications of the Derivative


Ａｐｐｌｉｃａｔｉｏｎｓ　ｉｎ　ｓａｌｅｓ　（ｄｖｄ　ｅｘａｍｐｌｅ）

● [00:29](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=29). 🧩 Applications in Sales (DVD Example) [📷image](../img/Calculus 1 Lecture 2.4/[00-30]-01.png)
     ◉ [01:30](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=90). Sales Model 𝑺(𝒕) over time 𝒕 (in years)
          ○ 𝑺(𝒕) =  7𝒕 / (𝒕² + 1)
     ...
     ◉ [02:45](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=165). Objectives of the Sales Model Analysis
     ...
     ◉ [04:40](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=280). ➀ Calculating the Rate of Change (the derivative 𝑺'(𝒕) or 𝒅𝑺/𝒅𝒕)
     ...
     ◉ [09:10](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=550). ➁  Finding when sales reach their peak
     ...
     ◉ [13:50](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=830). ➂ Finding the initial rate of increase of sales (at 𝒕=0)
...
● [17:00](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=1020). Applications in Physics (Kinematics)  [📷image](../img/Calculus 1 Lecture 2.4/[17-00]-01.png)
     ...
     ◉ [21:52](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=1312). 🧩 Example –: 𝑺(𝒕) =  2𝒕³ - 15𝒕² + 24𝒕) Finding Acceleration and Jerk from a Position function (in 𝒕 seconds).  [📷image-1](../img/Calculus 1 Lecture 2.4/[21-52]-02.png) [📷image-2](../img/Calculus 1 Lecture 2.4/[21-52]-01.png)
     ...
     ◉ [24:47](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=1487). Calculating Acceleration at a specific moment (e.g., 𝒕=3 seconds)
          ○ Evaluate Acceleration 𝓐(𝒕) at 𝒕=3: 𝓐(3)
          ○ 𝓐(3) = 6 (units, e.g., ft/s²)
     ◉ [25:41](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=1541). Find when Acceleration is zero
...
● [27:40](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=1660). Applications in Projectiles (Fireworks Example)  [📷image](../img/Calculus 1 Lecture 2.4/[27-40]-01.png) 
     ◉ 🧩 Example –: 𝑺(𝒕) = -16𝒕² + 256𝒕 Model for height (Position 𝑺(𝒕)) of a firework at time 𝒕
          ...
          ○ [28:50](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=1730). Objective: Find the maximum height
...
● [32:10](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=1930). Applications in Business and Economics (Marginal Cost)
     ...
     ◉ [32:59](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=1979). 🧩 Example –: 𝑪(𝒙) = -0,2𝒙² + 200𝒙 + 9000, of a Total Cost function 𝑪(𝒙) [📷image](../img/Calculus 1 Lecture 2.4/[32-10]-01.png) 
          ○ Interpretation of initial cost (at 𝒙=0): it is the cost when nothing is produced
               ■ Initial cost (overhead) is 𝑪(0) = 9.000$
     ◉ [36:00](https://www.youtube.com/watch?v=qr1WXiq3S3k&list=PLF797E961509B4EB5&t=2160). Calculating the Marginal Cost function (the derivative 𝑪'(𝒙))
          ○ 𝑪'(𝒙) = - 0,4𝒙 + 200
