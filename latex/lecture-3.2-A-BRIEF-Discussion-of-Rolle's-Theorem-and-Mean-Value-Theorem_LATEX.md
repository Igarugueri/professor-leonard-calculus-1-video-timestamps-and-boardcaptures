...
● [0:28](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=28). Explanation of Rolle's Theorem
...
● [1:14](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=74). Interpretation: At least one point between the two 𝒙-axis crossings will have a horizontal tangent.


● [1:25](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=85). Transition to the Mean Value Theorem as a corollary of Rolle's Theorem.


● [3:18](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=198). Formal definition of Rolle's Theorem.
...
● [1:34](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=94). Introduction to the Mean Value Theorem.
     ◉ Prerequisites:
          ○ The function must be continuous on the closed interval [𝓪, 𝓫].
          ○ The function must be differentiable on the open interval (𝓪, 𝓫).
     ◉ Implications:
...
● [1:41](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=101). Explanation of the Mean Value Theorem:
...
● [2:23](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=143). Interpretation: At least one point 𝓬 within the interval (𝓪,𝓫) will have a tangent line 
                with 𝓪 slope equal to the slope of the secant line that connects the endpoints (𝓪, 𝒇(𝓪)) and (𝓫, 𝒇(𝓫)).

              
● [2:42](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=162). Relationship with Rolle's Theorem.
...
● [3:57](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=237). Formal definition of the Mean Value Theorem:
...
● [4:26](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=266). Interpretation of the formula: The slope of the tangent at point 𝓬 is equal to the slope of the secant connecting
...
● [5:20](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=320). How to verify Rolle's Theorem:
...
● [5:37](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=337). How to verify the Mean Value Theorem:
     ◉ Verify that the function is continuous on [𝓪, 𝓫] and differentiable on (𝓪, 𝓫).  
     $\rule{0pt}{}$
     ◉ Calculate the slope of the secant line: $\dfrac{𝒇(𝓫)-𝒇(𝓪)}{𝓫-𝓪}$.  
     $\rule{0pt}{}$
     ◉ Differentiate the function and solve $𝒇'(𝒙)=\dfrac{𝒇(𝓫)-𝒇(𝓪)}{𝓫-𝓪}$ to find the value(s) of 𝒙 where 𝒙 = 𝓬.
     $\rule{0pt}{}$
     ◉ Ensure that the solution(s) lie within the open interval (𝓪, 𝓫).


● [6:04](https://www.youtube.com/watch?v=qW89xdGfSzw&list=PLF797E961509B4EB5&t=364). Simple summary: [📷image](../img/Calculus 1 Lecture 3.2/[6-04]-01.png)
