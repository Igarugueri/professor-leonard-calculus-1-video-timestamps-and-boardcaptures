...
● [3:20]. Creating the formula for the slope of a curve from the slope of a secant line (that conect two points).
     ◉ [4:03]. Definitions:  📷
          ○ A curve
     ...
     ◉ [6:44]. Calculating the 𝒚-values of the points: 𝒇(𝒙₀) and 𝒇(𝒙₀ + h).
     ◉ [7:24]. Reminder of the goal: finding the slope of the curve at point P.
     ◉ [8:32]. Calculating the slope of the secant line (Δ𝒚 / Δ𝒙) using points P and Q. 📷
          ○  Δ𝒙 = 𝒙₀ + h - 𝒙₀ = h and   Δ𝒚 = 𝒇(𝒙₀ + h)  - 𝒇(𝒙₀)
               ■ m =  (𝒇(𝒙₀ + h)  - 𝒇(𝒙₀))  /  h
     ◉ [14:00]. Introducing the concept of a limit to bring Q closer to (infinitely smaller) P: this is (h → 0). 📷
          ○ Transition from the slope of the secant (m) to the slope of the tangent (m_tan)
              using the limit: 
               ■ m_tan = limₕ→₀ (𝒇(𝒙₀ + h) - 𝒇(𝒙₀))  /  h
     ◉ [17:30]. Explanation of why we cannot simply set h = 0 (undefined).

● [18:33]. 🧩 Example 1 – Finding the equation of the tangent line to: 𝒚 = x² at (1, 1) 📷 📷
     ◉ [19:42]. Steps to find the equation of the tangent line.
          ...
          ○ [28:20].  Using the point-slope form to find the equation of the tangent line at (1,1).
               ■  𝒚 - 𝒚₁ = 𝒎(𝒙 - 𝒙₁).
               ■ The equation of the tangent line is 𝒚 = 2x - 1.
                    
● [30:55]. 🧩 Example 2 – Finding the equation of the tangent line to 𝒚 = 3/x at (3, 1) 📷 📷
     ◉ [30:55]. Steps to restating the goal and using the formula for the slope of the tangent.
          ...
          ○ [41:20]. Using the point-slope form to find the equation of the tangent line at (1,1).
               ■  𝒚 - 𝒚₁ = 𝒎(𝒙 - 𝒙₁).
               ■ The equation of the tangent line is 𝒚 = -1/3x + 2.                  

● [44:57]. 🧩 Example 3 –  Finding the slope of tangent lines to 𝒚 = √x at any point 📷  📷
     ◉ [44:57]. Objective: derive a general formula for the slope of the tangent to 𝒚 = √x at any point x.
          ...
          ○ [55:00]. Obtaining the general formula for the slope of the tangent: m = 1/(2√x).
...
● [58:54]. Introduction to applications.
...
● [59:03]. Distance traveled over elapsed time.
     ◉ V_ave = displacement / time = (𝒇(t₀ + h) - 𝒇(t₀)) / h  
           
● [1:01:26]. Relationship between the average velocity formula and the slope formula.
...
● [1:02:20]. 🧩  Example: Finding average velocity of s(t) = 1 + 3t - 2t² over the interval [1,3] 📷
     ◉ [1:03:35]. Identification of t₀ = 1 and h = 2.
     ◉ Calculating s(t₀ + h) = s(3) = -8.
     ◉ Calculating s(t₀) = s(1) = 2.
     ◉ Computing the average velocity: (s(3) - s(1)) / 2 = (-8 - 2) / 2 = -5.
           
● [1:08:55]. Introduction to the difference between velocity and speed.
     ◉ Average Velocity:
          ○ Type: Vector
...
● [1:10:02]. Velocity at a specific instant in time.
     ◉ [1:11:25]. 𝙃𝙤𝙬 𝙢𝙪𝙘𝙝 𝙩𝙞𝙢𝙚 𝙚𝙡𝙖𝙥𝙨𝙚𝙨 𝙞𝙣 𝙖𝙣 𝙞𝙣𝙨𝙩𝙖𝙣𝙩?
           
● [1:12:55]. Instantaneous velocity is found by letting h approach zero in the average velocity formula.
     ◉ [1:13:23]. This involves using a limit.
          ○ How we make average velocity instant?
          ○ limₕ→₀  (𝒇(t₀ + h) - 𝒇(t₀))/ h; h = time
                      
● [1:14:20]. Relationship between instantaneous velocity and the slope of a curve at a point.
     ◉ Both represent the instantaneous rate of change.
           
● [1:15:23]. 🧩 Example: Finding instantaneous velocity of s(t) = 500 - 16t² after 5 seconds.  📷  📷
     ◉ limₕ→₀  (s(t₀ + h) - s(t₀))/ h 
     ...
     ◉ [1:27:00]. Substituting into the instantaneous velocity formula and simplifying.
          ...
          ○ Evaluate the limit as h approaches 0:
                 V_inst = -160 ft/sec
     ◉ [1:32:37]. Computing the instantaneous velocity in general (for any time t so  ̵t̵₀̵ ̵=̵ ̵5̵)  and obtaining the formula: v(t) = -32t. 📷
...
● [1:39:23]. Connection between slope and rate of change.
     ◉ The slope is a rate of change.
         
● [1:39:59]. The average rate of change is the slope of the secant line between two points.

● [1:41:58]. The instantaneous rate of change is the slope of the curve at one point.

● [1:43:10]. Rate of change:
     ◉ Average rate of change:          r_av = (𝒇(𝒙₀ + h) - 𝒇(𝒙₀)) / h
     ◉ instantaneous rate of change: r_inst =  limₕ→₀  (𝒇(𝒙₀ + h) - 𝒇(𝒙₀))  / h 
           
● [1:46:37]. 🧩 Example: Finding the average and instantaneous rate of change of a curve  𝒇(𝒙) = 3𝒙² - 4, r_ave:[2,5] and  r_inst:-2
     ◉ Average rate of change: r_av = (𝒇(𝒙₀ + h) - 𝒇(𝒙₀)) / h
          ○ 𝒇(𝒙₀) = 𝒇(2) 
          ○ 𝒇(𝒙₀ + h) = 𝒇(2 + (5-2) ) = 𝒇(5) 
