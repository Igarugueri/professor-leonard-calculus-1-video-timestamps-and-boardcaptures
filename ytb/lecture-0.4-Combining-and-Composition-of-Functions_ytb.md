...
● [0:44]. Introduction to Combining Functions: addition, subtraction, multiplication, division. 
      ◉ [0:57]. 🧩 Example – with functions: 𝒇(𝒙) = 1 + √(𝒙 − 2) and 𝓰(𝒙) = 𝒙 − 3  
...
● [3:58]. Domain of Combined Functions 
...
● [7:37]. Introduction by examples to Composition of Functions 
     ◉ [7:56]. 🧩 Example –: 𝒇(𝒙) = 𝒙³ − 4 and 𝓰(𝒙) = √𝒙  
          ○ [8:29]. Composition (𝒇 ∘ 𝓰)(𝒙) = 𝒇(𝓰(𝒙))  
                ■ (𝒇 ∘ 𝓰)(𝒙) = 𝒇(𝓰(𝒙)) = 𝒇(√𝒙) = (√𝒙)³ − 4
          ○ [10:15]. Composition (𝓰 ∘ 𝒇)(𝒙) = 𝓰(𝒇(𝒙))  
                ■ (𝓰 ∘ 𝒇)(𝒙) = 𝓰(𝒇(𝒙)) = 𝓰(𝒙³ − 4) = √(𝒙³ − 4)

● [11:07]. Multiple Composition of Functions by example 
    ◉ [11:26]. 🧩 Example –: 𝒇(𝒙) = √𝒙, 𝓰(𝒙) = 1/𝒙, and 𝒉(𝒙) = 𝒙³  
         ○ [11:51]. (𝒇 ∘ 𝓰 ∘ 𝒉)(𝒙)  
               ■ (𝒇 ∘ 𝓰 ∘ 𝒉)(𝒙) = 𝒇(𝓰(𝒉(𝒙))) = 𝒇(𝓰(𝒙³)) = 𝒇(1 / 𝒙³)  = √(1 / 𝒙³) = 1 / √(𝒙³) = 1 / 𝒙^(3/2)
         ○ [13:30]. (𝒇 ∘ 𝓰 ∘ 𝒉)(8)  
               ■ (𝒇 ∘ 𝓰 ∘ 𝒉)(8) = 1 / 8³ᐟ²

● [14:44]. Decomposing a Function into a Composition of Functions by example 
